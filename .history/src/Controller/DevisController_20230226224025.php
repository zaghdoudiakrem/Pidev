...
class DevisController extends AbstractController
{
    ...
    public function addStudentJSON(Request $req, DevisRepository $devisRepository,   normalizerInterface $Normalizer)
    {
    ...
    #[Route("updateDevisJSON/{id}", name: "updateStudentJSON")]
