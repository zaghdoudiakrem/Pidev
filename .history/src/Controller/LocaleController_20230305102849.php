...
class LocaleController extends AbstractController
{
  ...
  #[Route('/locale/searchLocalex', name:'localeListx')]
public function searchLocalex(Request $request, SerializerInterface $serializer, LocaleRepository $localeRepository)
{
    ...
    $jsonData = $serializer->serialize($locales, 'json', ['groups' => "locale"]);
