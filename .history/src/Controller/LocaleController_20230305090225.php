...
class LocaleController extends AbstractController
{
  ...
  #[Route('/searchLocalex', name:'localeListx', methods: ['GET'])]
  public function searchLocalex(Request $request,NormalizerInterface $Normalizer)
  {
      ...
      $jsonContent = $Normalizer->normalize($students, 'json',['groups'=>'locale']);
      ...
      $repository = $this->getDoctrine()->getRepository(Student::class);
        ...
        $jsonContent = $Normalizer->normalize($students, 'json',['groups'=>'students']);
        $retour=json_encode($jsonContent);
        return new Response($retour);
