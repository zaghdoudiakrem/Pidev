...
class LocaleController extends AbstractController
{
  ...
  public function searchLocalex(Request $request,NormalizerInterface $Normalizer,LocaleRepository $sr)
  {
...
public function searchLocalex(Request $request, NormalizerInterface $normalizer, LocaleRepository $localeRepository)
{
    ...
    $locales = $localeRepository->findLocaleBySearchValue($searchValue);
