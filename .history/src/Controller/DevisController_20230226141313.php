...
class DevisController extends AbstractController
{
    ...
    public function getDeviss(DevisRepository $repo, SerializerInterface $serializer)
    {
        $devis = $this->getDoctrine()->getRepository(Devis::class)->findAll();
    ...
    public function DevisId($id, NormalizerInterface $normalizer, DevisRepository $repo)
    {
        $Devis = $repo->find($id);
        $DevisNormalises = $normalizer->normalize($Devis, 'json', ['groups' => "Deviss"]);
