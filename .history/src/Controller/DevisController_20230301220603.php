...
class DevisController extends AbstractController
{
    ...
    #[Route('/{id}/print', name: 'app_devis_generate_pdf')]
    public function generatePdfAction($id,Devis $devis, Pdf $pdf)
{$html = $this->renderView('devis/print.html.twig', [
    'devis' => $devis,
]);

$pdf->generateFromHtml($html, 'devis.pdf');

// Return the PDF file as a response
return new BinaryFileResponse('devis.pdf');
