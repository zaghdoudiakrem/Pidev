 ...
 */
class getLocaleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LocaleRepository' shared autowired service.
     *
     * @return \App\Repository\LocaleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LocaleRepository.php';

        return $container->privates['App\\Repository\\LocaleRepository'] = new \App\Repository\LocaleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
