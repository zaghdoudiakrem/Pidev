 ...
 */
final class Version20230307140025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE id_client_id id_client_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE id_client_id id_client_id INT DEFAULT NULL');
